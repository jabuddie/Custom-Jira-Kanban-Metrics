...
def plot_lead_time_distribution(df, project_key):
    ...
    plt.title("Lead Time Distribution - {project_key.upper()}")
...
def plot_lead_time_heatmap_by_assignee(df):
    ...
    plt.title("Average Lead Time by Assignee")
    plt.xlabel("")
    plt.ylabel("Assignee")
    plt.tight_layout()
    plt.show()
...
def plot_cycle_time_distribution(df, project_key):
    ...
    plt.title("Cycle Time Distribution - {project_key.upper()}")
...
def plot_cycle_time_heatmap_by_assignee(df):
    ...
    plt.title("{project_key.upper()} - Average Cycle Time by Assignee")
    plt.xlabel("")
    plt.ylabel("Assignee")
    plt.tight_layout()
    plt.show()
...
def show_daily_wip_table(wip_records, days_lookback):
    import pandas as pd
    from datetime import datetime, timedelta, timezone
...
def plot_monthly_average_wip(wip_records, months_lookback, project_key):
    ...
    ax.set_title("Monthly Average WIP (Daily-based)")
    ax.set_xlabel("Month")
